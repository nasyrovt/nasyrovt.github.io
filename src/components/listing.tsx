  ...
  return (
    <Container sx={{ py: 4 }}>
      ...
      <p sx={{ mt: 6, fontSize: [1, 2, 2, 3], textAlign: `center` }}>
        <span sx={{ fontWeight: `bold` }}>More Projects are coming soon ...</span> <br /> In the meantime you can have a
        look at my already existing{` `}
        <Themed.a href="https://github.com/nasyrovt">
          Unreal and Unity game projects...
        </Themed.a>
        !
      </p>
    </Container>
