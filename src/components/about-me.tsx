      ...
      <Container>
        <div sx={{ maxWidth: `760px` }}>
          ...
          <Themed.p>
            ...
            passionate about working on game projects & developing a good experience for people who plays them.
          </Themed.p>
          <Themed.p>
            You can find me on my <Themed.a href="https://www.google.com">Homepage</Themed.a> where I post my Games and
            Web Projects. I also like to experiment with 3D sometime.
              I'm currently studying Game Programming & Design in <Themed.a href="https://www.ynov.com/formation/ynov-masteres/jeux-video-programming/">Lyon Ynov Campus</Themed.a>.
              And I'm also a Fullstack Engine Developer in <Themed.a href="https://cabri.com/">Cabrilog</Themed.a>.

          </Themed.p>
          <Themed.p>
            I started learning Game Development with Unity in 2020  since then I created a bunch of mini games implementing
            a variety of different gameplay mechanics. I myself learned so much with free and open source content as well
              as paid courses from Udemy, <Themed.a href="https://www.gamedev.tv/">GameDev.TV</Themed.a> Unity & Unreal courses.
          </Themed.p>
        </div>
      </Container>
      ...
      <Container sx={{ mt: [6, 7], position: `relative` }}>
        ...
        >
          ...
          <Themed.p sx={{ textShadow: `0 1px 1px rgba(0, 0, 0, 0.2)` }}>
            I'm grateful for every form of support: Share this website or my CV with your friends & colleagues, buy me a tea
